...
import ProfessorDialog from "./AddProfesseorDailoge";
import { useState, useEffect } from "react";
import { GridActionsCellItem } from "@mui/x-data-grid";
import EditIcon from "@mui/icons-material/Edit";
import DeleteIcon from "@mui/icons-material/DeleteOutlined";
import AddMultipleStudents from "./AddMultipalProferssor";
import Checkbox from "@mui/material/Checkbox";

const ProfessorCollection = () => {
  ...
  const loadData = () => {
    getProfessor().then(setStudentCollection);
  };
  ...
  const handleSharedClick = (row) => async (event) => {
    await updateProfessor({ ...row, shared: event.target.checked });
    loadData();
  };
  const columns = [
...
export default ProfessorCollection;
